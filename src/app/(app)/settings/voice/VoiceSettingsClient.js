  ...
  return (
    <PageWrapper>
      ...
      <InfoCard>
        ...
        <InfoText>
          Use the microphone button in the chat bar to speak to Koda. When voice responses are on,
          Koda will read replies aloud automatically. You can also tap the speaker icon on any
          message to hear it.
        </InfoText>
      </InfoCard>
      ...
      <Section>
        ...
        <ToggleRow onClick={() => toggle('voice_responses_enabled')}>
          <ToggleInfo>
            ...
            <ToggleDesc>
              When Koda replies, automatically speak the response using text-to-speech. You can stop
              playback at any time by tapping the speaker icon.
            </ToggleDesc>
          </ToggleInfo>
          <Switch $on={settings.voice_responses_enabled} />
        </ToggleRow>
        <SectionNote>
          Voice input (microphone) is always available regardless of this setting. This only
          controls whether Koda reads responses out loud.
        </SectionNote>
      </Section>
      ...
      <Section>
        ...
        <SectionNote style={{ margin: 0, fontStyle: 'normal' }}>
          Voice input works best in Chrome and Safari. Text-to-speech is supported in all modern
          browsers. On mobile, Koda uses your device{'\u2019'}s built-in speech engine for the most
          natural experience.
        </SectionNote>
      </Section>
