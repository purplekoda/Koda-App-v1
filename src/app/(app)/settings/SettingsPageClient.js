  ...
  return (
    <PageWrapper>
      ...
      <SectionBlock>
        ...
        <CardGroup>
          <SettingsCard
            href="/settings/household-members"
            icon="&#x1F464;"
            bg="#E1F5EE"
      ...
      <SectionBlock>
        ...
        <CardGroup>
          <SettingsCard
            href="/settings/cook-time"
            icon="&#x23F1;&#xFE0F;"
            bg="#FEF3C7"
            title="Weeknight cooking time"
            summary={cookTimeSummary}
          />
          <SettingsCard
            href="/settings/meal-plan-days"
            icon="&#x1F4C5;"
            bg="#DBEAFE"
            title="Meal planning days"
            summary={mealPlanDaysSummary}
          />
        </CardGroup>
      </SectionBlock>
      ...
      <SectionBlock>
        ...
        <CardGroup>
          <SettingsCard
            href="/settings/dietary-restrictions"
            icon="&#x1F957;"
            bg="#E1F5EE"
      ...
      <SectionBlock>
        ...
        <CardGroup>
          ...
          />
          <SettingsCard
            href="/settings/favorite-stores"
            icon="&#x1F6D2;"
            bg="#E1F5EE"
            title="Favorite grocery stores"
      ...
      <SectionBlock>
        ...
        <CardGroup>
          <SettingsCard
            href="/settings/health-goals"
            icon="&#x1F4AA;"
            bg="#EDE9FE"
            title="Health goals and macros"
            summary={healthSummary}
          />
          <SettingsCard
            href="/settings/macro-logging"
            icon="&#x1F4F7;"
            bg="#E1F5EE"
            title="Photo macro logging"
            summary="Per-member photo logging controls"
          />
        </CardGroup>
      </SectionBlock>
      ...
      <SectionBlock>
        ...
        <CardGroup>
          <SettingsCard
            href="/settings/recipe-card"
            icon="&#x1F0CF;"
            bg="#EDE9FE"
            title="Recipe card display"
            summary={recipeCardSummary}
          />
        </CardGroup>
      </SectionBlock>
      ...
      <SectionBlock>
        ...
        <CardGroup>
          ...
          <SettingsCard
            ...
            bg="#DBEAFE"
            title="Notifications"
            summary="Manage notification preferences"
          />
