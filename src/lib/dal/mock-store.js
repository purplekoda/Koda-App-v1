...
export async function updateMockMeal(day, type, update) {
  ...
  if (!mealObj) {
    ...
    if (
      ['sides2', 'sides3', 'sides4', 'breakfast_side', 'lunch_side', 'dinner_dessert'].includes(
        type,
      )
    ) {
...
export async function saveCommittedScanItemsToMock(scanItems, manualItems, deleteExistingManual) {
  ...
  const kept = items.filter(
    (i) => i.source !== 'scan' && (deleteExistingManual ? i.source !== 'manual' : true),
  );
  items.length = 0;
  items.push(...kept);
...
const MOCK_STAPLES_SEED = [
  ...
  },
  {
    ...
    out_of_stock_since: '2026-05-06T10:00:00.000Z',
    is_custom: false,
    created_at: '2026-03-01T10:00:00.000Z',
  },
  {
  ...
  },
  {
    id: 'st-11',
    name: 'Garlic cloves',
    category: 'Fresh Produce Staples',
    is_out_of_stock: false,
    out_of_stock_since: null,
    is_custom: false,
    created_at: '2026-03-01T10:00:00.000Z',
  ...
  },
  {
    id: 'st-13',
    name: 'Butter',
    category: 'Dairy & Refrigerator Staples',
    is_out_of_stock: false,
    out_of_stock_since: null,
    is_custom: false,
    created_at: '2026-03-01T10:00:00.000Z',
  ...
  },
  {
    ...
    category: 'Dairy & Refrigerator Staples',
    is_out_of_stock: true,
    out_of_stock_since: '2026-05-07T08:00:00.000Z',
    is_custom: false,
    created_at: '2026-03-01T10:00:00.000Z',
  },
];
...
export async function getMockStaples() {
  return ensureInitialized('staples', async () => JSON.parse(JSON.stringify(MOCK_STAPLES_SEED)));
}
