...
const mockSuggestions = {
  bread: {
    ...
    description:
      'Crispy garlic bread pairs perfectly with pasta dishes and uses butter and garlic you already have.',
  ...
  side_dish: {
    ...
    description:
      'A simple, nutritious side that complements protein-heavy mains with a bright citrus finish.',
  ...
  dessert: {
    ...
    description:
      'A light, naturally sweet dessert that uses pantry staples and takes almost no effort.',
  ...
  appetizer: {
    ...
    description:
      'Fresh tomato bruschetta adds a light, flavorful start that complements Italian-inspired meals.',
    cook_time: '10 minutes',
    pantry_match: false,
