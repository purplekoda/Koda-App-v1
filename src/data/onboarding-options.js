...
export const ADVENTUROUSNESS_OPTIONS = [
  ...
  { value: 'mix_it_up', label: '🎲 Mix it up', subtitle: 'Some favorites, some new ideas' },
  {
    value: 'surprise_me',
    label: '🎉 Surprise me',
    subtitle: 'I love trying new things every week',
  },
];
...
export const MEAL_PREP_STYLE_OPTIONS = [
  ...
  {
    value: 'cook_fresh',
    label: '🍳 I cook fresh daily',
    subtitle: 'I prefer to cook each meal as I go',
  },
...
export const FRUSTRATION_OPTIONS = [
  ...
  {
    value: 'deciding',
    label: '🤔 Deciding what to cook',
    subtitle: 'I never know what to make each night',
  },
  {
    value: 'not_enough_time',
    label: '⏰ Not enough time',
    subtitle: 'My schedule makes cooking hard',
  },
  {
    value: 'grocery_budget',
    label: '💸 Grocery budget',
    subtitle: 'I spend too much at the store',
  },
  {
    value: 'boring_meals',
    label: '😴 Boring meals',
    subtitle: 'We eat the same things every week',
  },
  {
    value: 'too_many_trips',
    label: '🛒 Too many grocery trips',
    subtitle: "I'm always running back to the store",
  },
  {
    value: 'eating_healthy',
    label: '🥗 Eating healthy consistently',
    subtitle: 'Good intentions but hard to stick to',
  },
];
...
export const SHOPPING_STYLE_OPTIONS = [
  {
    value: 'deal_hunter',
    label: 'I shop around for the best deals',
    subtitle: "I'll visit multiple stores if it saves money",
    icon: '\uD83C\uDFF7\uFE0F',
  },
  {
    value: 'convenience',
    label: 'I shop at the same stores for convenience',
    subtitle: 'Good deals are nice but not worth the extra trips',
    icon: '\uD83D\uDED2',
  },
  {
    value: 'pickup_only',
    label: 'I only use stores that offer pickup',
    subtitle: 'I order online and grab it curbside',
    icon: '\uD83D\uDE97',
  },
  {
    value: 'delivery_preferred',
    label: 'I prefer delivery to my door',
    subtitle: 'Instacart, DoorDash, or store delivery works for me',
    icon: '\uD83D\uDCE6',
  },
  {
    value: 'flexible',
    label: 'It depends on the week',
    subtitle: 'Sometimes I shop, sometimes I deliver \u2014 whatever works',
    icon: '\uD83D\uDD04',
  },
];
...
export const HEALTH_GOAL_OPTIONS = [
  {
    value: 'weight_loss',
    label: '⚖️ Weight loss',
    subtitle: 'Lower calorie meals that still feel satisfying',
  },
  {
    value: 'muscle_gain',
    label: '💪 Muscle gain',
    subtitle: 'High protein meals to support strength goals',
  },
  { value: 'maintenance', label: '⚡ Maintenance', subtitle: 'Balanced meals to stay where I am' },
  {
    value: 'more_energy',
    label: '🔋 More energy',
    subtitle: 'Meals that fuel me through busy days',
  },
  {
    value: 'heart_health',
    label: '❤️ Heart health',
    subtitle: 'Lower sodium, healthy fats, less processed food',
  },
  {
    value: 'track_macros',
    label: '📊 Track my macros',
    subtitle: 'Monitor protein, carbs, and fats to hit my targets',
  },
  {
    value: 'gut_health',
    label: '🦠 Gut health',
    subtitle: 'More fiber, fermented foods, less inflammation',
  },
  {
    value: 'blood_sugar',
    label: '🩸 Blood sugar management',
    subtitle: 'Lower carb meals to help keep blood sugar steady',
  },
  {
    value: 'just_eating_well',
    label: '😊 Just eating well',
    subtitle: 'No specific goal — just want good wholesome food',
  },
];
...
export const PERMISSION_GROUPS = [
  {
    ...
    permissions: [
      {
        key: 'can_view_meal_plan',
        label: 'View meal plan',
        description: 'See the weekly meal plan',
        defaultValue: true,
      },
      {
        key: 'can_edit_meal_plan',
        label: 'Edit meal plan',
        description: 'Add, remove, or swap meals',
        defaultValue: true,
      },
    ],
  },
    ...
    permissions: [
      {
        key: 'can_add_recipes',
        label: 'Add recipes',
        description: 'Save new recipes to the Recipe Box',
        defaultValue: true,
      },
      {
        key: 'can_edit_recipes',
        label: 'Edit recipes',
        description: 'Modify existing recipes',
        defaultValue: false,
      },
      {
        key: 'can_delete_recipes',
        label: 'Delete recipes',
        description: 'Remove recipes from the household',
        defaultValue: false,
      },
    ],
  },
  {
    ...
    permissions: [
      {
        key: 'can_add_to_grocery_list',
        label: 'Add to grocery list',
        description: 'Add items to the shared list',
        defaultValue: true,
      },
      {
        key: 'can_send_grocery_list',
        label: 'Send grocery list',
        description: 'Send the list to a store for delivery',
        defaultValue: false,
      },
    ],
  },
    ...
    permissions: [
      {
        key: 'can_view_pantry',
        label: 'View pantry',
        description: 'See pantry contents',
        defaultValue: true,
      },
      {
        key: 'can_edit_pantry',
        label: 'Edit pantry',
        description: 'Add or remove pantry items',
        defaultValue: false,
      },
    ],
  },
