...
export const ONBOARDING_SYSTEM_PROMPT =
  ...
  "- When you have collected every required item respond with exactly the phrase " + ONBOARDING_COMPLETION_MARKER + " on its own line followed by a JSON object on the next line containing all collected data.\n" +
  "- Never say " + ONBOARDING_COMPLETION_MARKER + " until every required item is filled.\n\n" +
  ...
  "  }\n" +
  "}\n\n" +
  "IMPORTANT: Do NOT include the " + ONBOARDING_COMPLETION_MARKER + " marker until you have confirmed every piece of required information. " +
...
export function getMockConversationResponse(messages) {
  ...
  if (count >= 14) {
    const mockData = {
      ...
      members: [
        { name: 'You', age: 35, age_group: 'adult', allergies: [], dietary_restrictions: [], is_picky_eater: false, picky_issues: [], track_macros: false, macro_calories: null, macro_protein_g: null, macro_carbs_g: null, macro_fat_g: null },
        { name: 'Partner', age: 33, age_group: 'adult', allergies: [], dietary_restrictions: [], is_picky_eater: false, picky_issues: [], track_macros: false, macro_calories: null, macro_protein_g: null, macro_carbs_g: null, macro_fat_g: null },
        { name: 'Kiddo', age: 7, age_group: 'child', allergies: ['Nuts'], dietary_restrictions: [], is_picky_eater: true, picky_issues: ['No vegetables'], track_macros: false, macro_calories: null, macro_protein_g: null, macro_carbs_g: null, macro_fat_g: null },
      ],
      schedule: { cook_time_preference: '20_to_40', meal_plan_days: [1, 2, 3, 4, 5], meal_prep_days: [7] },
      food_preferences: { cuisines: ['Italian', 'Mexican', 'Thai'], adventurousness: 'mix_it_up', meal_prep_style: 'mix', cooking_frustrations: ['deciding', 'food_waste'] },
      budget: { weekly_budget: 150, shopping_style: 'convenience', preferred_delivery_service: null, preferred_stores: ['Kroger', 'Costco'] },
...
export function getMockPartialExtraction(messages) {
  ...
  return {
    ...
    members: userCount >= 2 ? [
      { name: 'You', age: 35, age_group: 'adult', allergies: [], dietary_restrictions: [], is_picky_eater: null, picky_issues: [], track_macros: null },
    ] : [],
