...
export const GROCERY_STORES = [
  {
    ...
    label: 'Walmart',
    color: '#378ADD',
    description: 'Everyday staples and groceries',
  },
  {
    value: 'kroger',
    label: 'Kroger',
  ...
  },
  {
    ...
    label: 'Costco',
    color: '#7F77DD',
    description: 'Bulk buying and household staples',
  },
  {
    value: 'albertsons',
    label: 'Albertsons',
  ...
  },
  {
    ...
    label: 'Publix',
    color: '#2D6E37',
    description: 'Southern staples and fresh deli',
  },
  {
    value: 'whole-foods',
    label: 'Whole Foods',
    color: '#639922',
    description: 'Organic and specialty items',
  },
  {
    value: 'target',
    label: 'Target',
    color: '#CC0000',
    description: 'Groceries plus household essentials',
  },
  ...
  { value: 'aldi', label: 'ALDI', color: '#00447C', description: 'Budget-friendly everyday items' },
  {
    ...
    label: "Trader Joe's",
    color: '#C3272B',
    description: 'Unique and seasonal specialty items',
  },
  {
    value: 'heb',
    label: 'HEB',
    color: '#EE3A24',
    description: 'Texas fresh produce and local brands',
  },
  {
    value: 'meijer',
    label: 'Meijer',
    color: '#E31837',
    description: 'Midwest one-stop grocery shopping',
  },
  {
    value: 'winco',
    label: 'WinCo',
    color: '#003366',
    description: 'Bulk and discount grocery staples',
  },
  {
    value: 'food-lion',
    label: 'Food Lion',
    color: '#F7941D',
    description: 'Affordable everyday grocery staples',
  },
  {
    value: 'shoprite',
    label: 'ShopRite',
    color: '#FF0000',
    description: 'Northeast grocery deals and fresh produce',
  },
  {
    value: 'sprouts',
    label: 'Sprouts',
    color: '#6B8E23',
    description: 'Natural and organic fresh foods',
  },
  {
    value: 'wegmans',
    label: 'Wegmans',
    color: '#004225',
    description: 'Premium fresh food and prepared meals',
  },
  {
    value: 'sams-club',
    label: "Sam's Club",
    color: '#007DC6',
    description: 'Wholesale club shopping',
  },
  {
    value: 'amazon',
    label: 'Amazon',
    color: '#FF9900',
    description: 'Online grocery and pantry delivery',
  },
